...
function draw(){
 ...
 ctx2d.drawImage(video,0,0,w,h);ctx2d.restore();overlay(w,h,lv);window.SOSProducerLayerManagerV4230?.draw?.(ctx2d,w,h,time,lv,projectDuration);applyTransitionOverlay(w,h,state);window.SOSClipTransitionsV4250?.draw?.(ctx2d,w,h,time);
