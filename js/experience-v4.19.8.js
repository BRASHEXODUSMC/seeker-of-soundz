...
function applySettings(settings){
 ...
 ["none","cubes","circlewave","orbitdots","radar","equalizer","pulsehalo","sparkorbit","hexring","vinyl"].forEach(value=>h.classList.toggle(`sos-loader-center-${value}`,s.loaderCenterEffect===value));
