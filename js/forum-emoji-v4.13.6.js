(() => {
  ...
  if (window.__SOS_FORUM_EMOJI_PICKER_V4136__) return;
  window.__SOS_FORUM_EMOJI_PICKER_V4136__ = true;
  ...
  modal.className = "emojiPickerModal emojiPickerModalV4136";
  modal.hidden = true;
  modal.innerHTML = `
    <section class="emojiPicker emojiPickerV4136" role="dialog" aria-modal="true" aria-label="Forum emoji library" tabindex="-1">
      <header>
        <div>
      ...
      <label class="emojiSearchLabel" for="forumEmojiSearchV4136">Search emojis</label>
      <input id="forumEmojiSearchV4136" class="emojiSearch" type="search" autocomplete="off" placeholder="Try music, happy, fire, food…">
  ...
  function enhanceToolbar(bar) {
    ...
    bar.dataset.emojiEnhanced = "v4.13.6";
  }
