...
try{
 ...
 if(!localStorage.getItem(migrationKey)){
  saved={loaderSwipe:false,loaderProgressStyle:'bar',loaderBarAnimation:'fill',loaderShowLogo:true,loaderShowOrbits:false,loaderShowGlow:false,loaderShowParticles:false,loaderShowBrand:true,loaderShowSubtitle:true,loaderShowStatus:true,loaderShowPercent:true,loaderLogoMotion:'none',loaderBackgroundStyle:'void',loaderBackgroundMotion:'still',loaderLogoSpeed:'normal',loaderBrandFont:'modern',loaderCenterEffect:'none'};
 ...
 root.classList.toggle('sos-loader-hide-orbits',saved.loaderShowOrbits!==true);
 root.classList.toggle('sos-loader-hide-glow',saved.loaderShowGlow!==true);
 ...
 const logoMotion=['pulse','spin','coin','tilt','float','glitch','none'].includes(saved.loaderLogoMotion)?saved.loaderLogoMotion:'none';
 const backgroundStyle=['cosmic','void','violet','blue','crimson','emerald','monochrome','aurora','grid'].includes(saved.loaderBackgroundStyle)?saved.loaderBackgroundStyle:'void';
 const backgroundMotion=['still','drift','pulse','rotate','waves'].includes(saved.loaderBackgroundMotion)?saved.loaderBackgroundMotion:'still';
 const speed=['slow','normal','fast'].includes(saved.loaderLogoSpeed)?saved.loaderLogoSpeed:'normal';
 const barAnimation=['fill','pulse','scanner','segments','bounce','spectrum','retro','minimal'].includes(saved.loaderBarAnimation)?saved.loaderBarAnimation:'fill';
 const brandFont=['modern','retro','arcade','digital','mono','wide','serif'].includes(saved.loaderBrandFont)?saved.loaderBrandFont:'modern';
 const centerEffect=['none','cubes','circlewave','orbitdots','radar','equalizer','pulsehalo','sparkorbit','hexring','vinyl'].includes(saved.loaderCenterEffect)?saved.loaderCenterEffect:'none';
