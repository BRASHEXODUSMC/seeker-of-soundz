      ...
      <form class="appForm" id="publicProfileForm">
        ...
        <section class="profileSoundSettingsV4153">
          ...
          <div class="profileStudioGrid">
            <label>Achievement chime
              <select name="achievementSound">
                ...
                <option value="bright-chime">Bright Chime</option>
                <option value="cosmic-confirm">Cosmic Confirm</option>
                <option value="arcade-ready">Arcade Ready</option>
                <option value="festival-rise">Festival Rise</option>
                <option value="bass-signal">Bass Signal</option>
            ...
            <label>Notification sound
              <select name="notificationSound">
                ...
                <option value="frequency-ping">Frequency Ping</option>
                <option value="message-pop">Message Pop</option>
                <option value="glass-tone">Glass Tone</option>
                <option value="laser-note">Laser Note</option>
                <option value="soft-knock">Soft Knock</option>
                <option value="cosmic-confirm">Cosmic Confirm</option>
          ...
          <div class="profileSoundControlsV4153">
            <label>Sound volume
              <input name="soundVolume" type="range" min="0" max="1" step="0.05">
            </label>
    ...
    form.onsubmit = async event => {
      ...
      try {
        ...
        window.SOSAudio?.write?.({
          ...
          volume: Number(fields.get('soundVolume') || .68),
