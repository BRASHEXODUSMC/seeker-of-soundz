...
captureSelectedYouTube?.addEventListener('click',event=>{
 ...
 const playbackTab=window.open(youtubeUrl,'sosYouTubeCaptureTab','noopener');
 setStatus('The YouTube project opened in a new tab. Choose that tab in the browser share dialog and enable Share tab audio.');
 window.dispatchEvent(new CustomEvent('sos:start-youtube-tab-capture',{detail:{url:youtubeUrl,opened:!!playbackTab,autoRecord:true}}));
});
